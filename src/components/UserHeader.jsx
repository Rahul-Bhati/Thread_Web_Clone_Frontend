...
const UserHeader = ({ user }) => {
     ...
     return (
          <VStack gap={4} align={"start"}>
               ...
               {currentUser._id === user._id && (<Link to="/update" className="profile_link">
                    <Button size={"sm"}>Update profile</Button>
               </Link>)}

               {currentUser._id !== user._id && (<Button size={"sm"} isLoading={updating} onClick={handleFollowUnFollow}>{following ? "Unfollow" : "Follow"}</Button>)}
